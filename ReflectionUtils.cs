...
namespace D10.Norm
{
    internal static class ReflectionUtils
    {
        ...
        public static List<FieldInfo> GetFields(Type targetType)
        {
            return GetFields(targetType, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
        }

        public static List<FieldInfo> GetFields(Type targetType, BindingFlags bindingAttr)
        {
            ValidationUtils.ArgumentNotNull(targetType, "targetType");

            List<FieldInfo> fieldInfos = new List<FieldInfo>(targetType.GetFields(bindingAttr));
            GetChildPrivateFields(new List<MemberInfo>(fieldInfos), targetType, bindingAttr);
        ...
        private static void GetChildPrivateFields(IList<MemberInfo> initialFields, Type targetType, BindingFlags bindingAttr)
        {
            ...
            if ((bindingAttr & BindingFlags.NonPublic) != 0)
            {
                ...
                BindingFlags nonPublicBindingAttr = BitUtils.Not(bindingAttr, BindingFlags.Public);

                while ((targetType = targetType.BaseType) != null)
                {
                    CollectionUtils.AddRange(initialFields, targetType.GetFields(nonPublicBindingAttr));
                }
            }
        }
        ...
        public static List<MemberInfo> FindMembers(Type targetType, MemberTypes memberType, BindingFlags bindingAttr, MemberFilter filter, object filterCriteria)
        {
            ...
            GetChildPrivateFields(memberInfos, targetType, bindingAttr);
