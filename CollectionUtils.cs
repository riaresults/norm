...
namespace D10.Norm
{
    internal static class CollectionUtils
    {
        ...
        public static void AddRange<T, U>(IList<T> initial, IEnumerable<U> collection) where U : T
        {
        ...
        {
            return Actions.TryAction<T>(delegate { return GetSingleItem(list, returnDefaultIfEmpty); }, out value);
        }
        ...
        /// </summary>
        /// <param name="listContentsType">The contents type of the list.</param>
        /// <returns></returns>
        public static object CreateGenericList(Type listContentsType)
        {
            ValidationUtils.ArgumentNotNull(listContentsType, "listContentsType");

            return ReflectionUtils.CreateGeneric(typeof(List<>), listContentsType);
        }
        ...
        /// <param name="listPopulator">The list populator.</param>
        /// <returns></returns>
        public static IList CreateAndPopulateList(Type listType, Action<IList> listPopulator)
        {
            ValidationUtils.ArgumentNotNull(listType, "listType");
            ValidationUtils.ArgumentNotNull(listPopulator, "listPopulator");
